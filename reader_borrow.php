...
?>
    ...
    <table width='100%' class="table">
        ...
        $sqla = "select sernum,book_info.book_id,book_info.name,lend_date from lend_list,book_info where reader_id={$username} and lend_list.book_id=book_info.book_id;";
        ...
        foreach ($resa as $row) {
            ...
            echo "<td><a href='reader_guihuan.php?id={$row['book_id']}'>归还</a></td>";
            echo "</tr>";
        };
        ?>
