...
?>
    ...
    <div style="padding: 180px 550px 10px;text-align: center">
        <form action="admin_book_jiechu.php?id=<?php echo $bookid; ?>" method="POST"
              class="bs-example bs-example-form" role="form">
            <div id="login">
                <div class="input-group"><span class="input-group-addon">借阅人</span><input name="borrower" type="text"
                                                                                          placeholder="请输入借阅人的学号"
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $jctsid = $_GET['id'];
    $reid = $_POST['borrower'];
    $sqlc = "select card_state from card_state where card_id={$reid}";
