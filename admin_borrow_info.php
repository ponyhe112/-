...
<table width='100%' class="table table-hover">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "select sernum,lend_list.book_id,name,reader_id,lend_date,state
...
where book_info.book_id=lend_list.book_id;";
    ...
    foreach ($res as $row) {
        ...
        echo "<td>";
        if ($row['state'] == 1) echo "已归还</td>"; else echo "<a href='admin_book_guihuan.php?id={$row['book_id']}'>立即归还</a> </td>";
        echo "</tr>";
    };
    ?>
</table>
